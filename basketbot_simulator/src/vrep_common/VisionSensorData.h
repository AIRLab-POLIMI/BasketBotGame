/* Auto-generated by genmsg_cpp for file /home/matteo/catkin_ws/src/vrep/vrep_common/msg/VisionSensorData.msg */
...
struct VisionSensorData_ {
  ...
  typedef  ::std_msgs::Int32_<ContainerAllocator>  _triggerState_type;
   ::std_msgs::Int32_<ContainerAllocator>  triggerState;

  typedef  ::std_msgs::Float32MultiArray_<ContainerAllocator>  _packetData_type;
   ::std_msgs::Float32MultiArray_<ContainerAllocator>  packetData;

  typedef  ::std_msgs::Int32MultiArray_<ContainerAllocator>  _packetSizes_type;
   ::std_msgs::Int32MultiArray_<ContainerAllocator>  packetSizes;
...
{
template<class ContainerAllocator> struct IsMessage< ::vrep_common::VisionSensorData_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::vrep_common::VisionSensorData_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
