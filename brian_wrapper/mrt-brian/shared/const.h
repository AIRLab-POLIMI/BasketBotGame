...
const char *BALL_TYPE = "Ball";
const char *TEAMMATE_TYPE = "TeamMate";
const char *OPPONENT_TYPE = "Opponent";
const char *GENERIC_OBJECT_TYPE = "Moving";
const char *MYSELF_TYPE = "Myself";

const char *X_POS = "X_Pos";
const char *Y_POS = "Y_Pos";
const char *X_SPEED = "X_Speed";
const char *Y_SPEED = "Y_Speed";
